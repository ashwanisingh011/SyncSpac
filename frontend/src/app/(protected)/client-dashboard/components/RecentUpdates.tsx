    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 shadow-sm">
      <div className="flex items-start justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">Real-time status updates</p>
        </div>
        ...
        <ul className="space-y-3.5">
          {updates.map((task) => (
            <li
              ...
              className="flex flex-col gap-1 py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-slate-100/70 dark:hover:bg-slate-800/40 transition-colors border border-transparent dark:border-slate-800 cursor-pointer"
            >
              <div className="flex items-start justify-between gap-3">
                <p className="text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-blue-600 transition-colors line-clamp-1">
                  {task.title}
                </p>
