        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl overflow-hidden p-6 space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800">
              ...
              <button onClick={() => setSelectedUser(null)} className="text-slate-400 hover:text-slate-700 dark:hover:text-slate-400 cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>

            <div className="flex flex-col items-center gap-2.5 py-2">
              <div className="w-16 h-16 rounded-full bg-blue-50 dark:bg-slate-800 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-2xl border border-blue-200 dark:border-slate-700 overflow-hidden">
                {selectedUser.avatar ? (
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                ...
                <span className="font-mono text-slate-700 dark:text-slate-400">{selectedUser.id}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
              ...
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                ...
                <span className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
                  selectedUser.status === 'active' ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-700'
                }`}>
                  {selectedUser.status}
                </span>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl overflow-hidden p-6 space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800">
              ...
              <button onClick={() => setSelectedOrg(null)} className="text-slate-400 hover:text-slate-700 dark:hover:text-slate-400 cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                ...
                <span className="font-bold text-slate-800 dark:text-white">{selectedOrg.name}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
              ...
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                <span className="text-slate-400 dark:text-slate-500 font-bold uppercase">Owner</span>
                <span className="font-semibold text-slate-700 dark:text-slate-300">{selectedOrg.owner}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                <span className="text-slate-400 dark:text-slate-500 font-bold uppercase">Subscription Tier</span>
                <span className="font-semibold text-slate-800 dark:text-slate-300 capitalize">{selectedOrg.plan}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
              ...
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                ...
                <span className="text-slate-700 dark:text-slate-300">{new Date(selectedOrg.createdAt).toLocaleDateString()}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-50 dark:border-slate-800">
                ...
                <span className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full capitalize ${
                  selectedOrg.status === 'active' ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-700'
                }`}>
                  {selectedOrg.status}
                </span>
              </div>
